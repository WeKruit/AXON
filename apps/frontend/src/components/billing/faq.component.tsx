  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by AXON?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information AXON will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      ...
      description: t(
        ...
        'AXON is proudly open-source! We believe in an ethical and transparent culture, meaning that AXON will live forever. You can check out the entire code or use it for personal projects.'
      ),
    },
    {
      ...
      description: t(
        ...
        `AXON allows you to schedule your posts between different channels.
