...
export const AccountsListComponent: FC = () => {
  const { data: accounts, isLoading, error, mutate } = useAccounts();
  ...
  if (isLoading) {
    return (
      <div className="flex-1 bg-newBgColorInner p-6" role="status" aria-label="Loading accounts">
    ...
    return (
      <div className="flex-1 bg-newBgColorInner p-6">
        <div
          ...
          aria-live="assertive"
        >
          <p className="text-red-500 dark:text-red-400">Failed to load accounts</p>
          <button
            onClick={() => mutate()}
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        ...
                        className="p-1.5 text-textItemBlur hover:text-newTextColor transition-colors focus:outline-none focus:ring-2 focus:ring-newPrimaryColor rounded"
                      ...
                      <button
                        ...
                        className="p-1.5 text-textItemBlur hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-500 rounded focus:opacity-100"
